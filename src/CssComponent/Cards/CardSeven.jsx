...
const CardSeven = () => {
  ...
  const cardHTML = `
  <div class="bg-[#4A00FF] shadow-xl rounded w-96 p-5">
    <h2 class="font-bold text-xl text-white">Card title!</h2>
    <p class="my-3 text-white">
        If a dog chews shoes whose shoes does he choose?
    </p>
    <div class="flex justify-end">
        <button class="px-5 py-3 bg-white text-black font-bold rounded">
        Buy Now
        </button>
    </div>
</div>
 `;
  ...
  const cardJSX = `
  <div className="bg-[#4A00FF] shadow-xl rounded w-96 p-5">
    <h2 className="font-bold text-xl text-white">Card title!</h2>
    <p className="my-3 text-white">
        If a dog chews shoes whose shoes does he choose?
    </p>
    <div className="flex justify-end">
        <button className="px-5 py-3 bg-white text-black font-bold rounded">
        Buy Now
        </button>
    </div>
</div>
