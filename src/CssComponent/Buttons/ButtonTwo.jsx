...
const ButtonTwo = () => {
  ...
  const cardHTML = `
  <button class="px-5 py-3 bg-[#0E668C] hover:bg-[#0F74A2] text-white font-bold rounded">
    Information
 </button>

 <button class="px-5 py-3 bg-[#D8A619] hover:bg-[#AA7D05] text-white font-bold rounded">
    Warning
 </button>

 <button class="px-5 py-3 bg-[#FF5760] hover:bg-red-700 text-white font-bold rounded">
    Error
 </button>

 <button class="px-5 py-3 bg-[#00A96D] hover:bg-[#176735] text-white font-bold rounded">
    Success
 </button>
 `;

  const cardJSX = `
  <button className="px-5 py-3 bg-[#0E668C] hover:bg-[#0F74A2] text-white font-bold rounded">
    Information
 </button>

 <button className="px-5 py-3 bg-[#D8A619] hover:bg-[#AA7D05] text-white font-bold rounded">
    Warning
 </button>

 <button className="px-5 py-3 bg-[#FF5760] hover:bg-red-700 text-white font-bold rounded">
    Error
 </button>

 <button className="px-5 py-3 bg-[#00A96D] hover:bg-[#176735] text-white font-bold rounded">
    Success
 </button>
      `;
